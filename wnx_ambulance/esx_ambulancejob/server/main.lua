...
ESX.RegisterServerCallback('esx_ambulancejob:getFineList', function(source, cb, category)
	MySQL.Async.fetchAll('SELECT * FROM fine_types_ambulance WHERE category = @category', {
		['@category'] = category
	}, function(fines)
		cb(fines)
	end)
...
AddEventHandler('esx_ambulancejob:removeItem', function(item)
	...
	if item == 'bandage' then
		TriggerClientEvent('system_notify:client:Notify', _source, _U{ type = 'msg', text = 'Použil jsi obvaz'})
	elseif item == 'medikit' then
		TriggerClientEvent('system_notify:client:Notify', _source, _U{ type = 'msg', text = 'Použil jsi medikit'})
	end
end)
...
AddEventHandler('esx_ambulancejob:giveItem', function(itemName)
	...
	if xItem.count < xItem.limit then
		...
		TriggerClientEvent('system_notify:client:Notify', _source, { type = 'false', text = 'Nemůžeš vzít více předmětů!'})
	end
end)
